...
!function (t, s, e) {
    ...
    var i = function (t, s) {
        ...
        this.el = t,
            ...
            e && this.options.stringsElement instanceof e ? this.stringsElement = this.options.stringsElement[0] : this.stringsElement = this.options.stringsElement,
    ...
    i.prototype = {
        ...
        build: function () {
            var t = this;
            if (this.showCursor === !0 && (this.cursor = s.createElement("span"),
                ...
                i.timeout = setTimeout(function () {
                    ...
                    i.timeout = setTimeout(function () {
                        if (s === t.length) {
                            ...
                            i.attr ? i.el.setAttribute(i.attr, e) : i.isInput ? i.el.value = e : "html" === i.contentType ? i.el.innerHTML = e : i.el.textContent = e,
                                s++,
                                i.typewrite(t, s)
                        }
                    }, e)
        ...
        backspace: function (t, s) {
            if (this.stop !== !0) {
                ...
                i.timeout = setTimeout(function () {
                    ...
                    var r = t.substr(0, s);
                    i.attr ? i.el.setAttribute(i.attr, r) : i.isInput ? i.el.value = r : "html" === i.contentType ? i.el.innerHTML = r : i.el.textContent = r,
                        s > i.stopNum ? (s--,
                            i.backspace(t, s)) : s <= i.stopNum && (i.arrayPos++,
                                i.arrayPos === i.strings.length ? (i.arrayPos = 0,
                                    ...
                                    i.init()) : i.typewrite(i.strings[i.sequence[i.arrayPos]], s))
                }, e)
            }
        },
        ...
        reset: function () {
            ...
            this.el.textContent = "",
                "undefined" != typeof this.cursor && "undefined" != typeof this.cursor.parentNode && this.cursor.parentNode.removeChild(this.cursor),
                this.strPos = 0,
                this.arrayPos = 0,
                this.curLoop = 0,
